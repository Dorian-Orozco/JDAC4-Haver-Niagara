...
namespace Haver_Niagara.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<ApplicationUser> signInManager, ILogger<LoginModel> logger, //inject the stuff into constructor
                        HaverNiagaraDbContext context, UserManager<ApplicationUser> userManager )
        {
